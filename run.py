...
def validate_data(sales_data):
    ...
    try:
        ...
        if data_sales < 0:
            raise ValueError(f"Figure 0 or greater required, you provided {sales_data}")
...
def get_advertising_data():
    ...
    while True:
        ...
        print(
            "Number of Advertising Cost Should be Greater Than or Equal to 0 and Less than 175"
        )
